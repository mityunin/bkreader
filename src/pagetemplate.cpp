...
//        QPixmap pagePattern("/home/sa/Downloads/brushed_alu.png");
	...
	QPixmap pageVertLine(1, this->b->getPageHeight());
        pageThinLine.fill(this->b->utils.paracolor);
	pageVertLine.fill(this->b->utils.paracolor);
...
//        pageBgShadow.fill(QColor(QColor("#C6C6C6")).rgb());
	...
	if( this->b->utils.columnsNum == 2 )
	  painter.drawPixmap(this->b->getPageWidth(true)/2, 0, 1, this->b->getPageHeight(), pageVertLine);
