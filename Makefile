...
# Generated by qmake (2.01a) (Qt 4.7.2) on: Thu Jul 7 16:26:09 2011
...
LINK          = g++
LFLAGS        = 
LIBS          = $(SUBLIBS)   -lz -lQtXml -lQtGui -lQtCore -lpthread 
AR            = ar cqs
RANLIB        = 
...
INSTALL_SHARE_FILES = /usr/share/bkreader/
INSTALL_BIN   = /usr/bin/
DEL_FILE      = rm -f
SYMLINK       = ln -f -s
DEL_DIR       = rmdir
DEL_NOT_EMPTY_DIR = rm -rf
MOVE          = mv -f
...
Makefile: bkreader.pro  /usr/lib/qt4/mkspecs/linux-g++/qmake.conf /usr/lib/qt4/mkspecs/common/g++-multilib.conf \
		/usr/lib/qt4/mkspecs/common/unix.conf \
		/usr/lib/qt4/mkspecs/common/linux.conf \
		/usr/lib/qt4/mkspecs/qconfig.pri \
		/usr/lib/qt4/mkspecs/modules/qt_webkit_version.pri \
...
install:   FORCE
	@$(CHK_DIR_EXISTS) /usr/share/bkreader || $(MKDIR) /usr/share/bkreader
	@$(INSTALL_PROGRAM) bin/bkreader /usr/bin/bkreader
	@$(COPY_DIR) bin/patterns /usr/share/bkreader/

uninstall:   FORCE
	@$(DEL_FILE) /usr/bin/bkreader
	@$(DEL_NOT_EMPTY_DIR) /usr/share/bkreader
