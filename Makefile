...
# Generated by qmake (2.01a) (Qt 4.8.0) on: Sun Mar 11 20:45:56 2012
# Project:  bkreader.pro
# Template: app
# Command: /usr/bin/qmake-qt4 -spec /usr/lib/qt4/mkspecs/linux-g++-32 -o Makefile bkreader.pro
#############################################################################
...
CFLAGS        = -m32 -pipe -O2 -O2 -Wall -W -D_REENTRANT $(DEFINES)
CXXFLAGS      = -m32 -pipe -O2 -O2 -Wall -W -D_REENTRANT $(DEFINES)
INCPATH       = -I/usr/lib/qt4/mkspecs/linux-g++-32 -I. -I/usr/include/QtCore -I/usr/include/QtGui -I/usr/include/QtXml -I/usr/include -Ibuild -Ibuild
LINK          = g++
LFLAGS        = -m32 -Wl,-O1
...
Makefile: bkreader.pro  /usr/lib/qt4/mkspecs/linux-g++-32/qmake.conf /usr/lib/qt4/mkspecs/common/unix.conf \
		/usr/lib/qt4/mkspecs/common/linux.conf \
		/usr/lib/qt4/mkspecs/common/gcc-base.conf \
		/usr/lib/qt4/mkspecs/common/gcc-base-unix.conf \
		/usr/lib/qt4/mkspecs/common/g++-base.conf \
	...
	$(QMAKE) -spec /usr/lib/qt4/mkspecs/linux-g++-32 -o Makefile bkreader.pro
